...
function itemDivCreate(itemNo){
    ...
    for(var i = 0; i < svtData.length ; i++){
		filterSkip = 0;
        if(i == 82 || i == 148 || i == 150 || i == 151 || i == 167 || i == 239 || i == 332 || i == 410 || i == 411 || i == 435 || i == 442 ) continue;  //跳過缺號的英靈
...
function mySelectSvtClass(noId,spanId,selectName){
    ...
    out +=  "<option value ='0'>盾 シールダー　　　【Shielder】</option><br>"
        ...
        +   "<option value ='14'>獣 ビースト　　　　【Beast】</option><br>"
    out += "</select>";
    $("#"+spanId).html(out);
}
...
function mySelectSvt(idNo,spanId,selectName,number){
    ...
    for(i = 0; i < number; i++){
		if( i == 82 || i == 148 || i == 150 || i == 151 || i == 167 || i == 239 || i == 332 || i == 410 || i == 411 || i == 435 || i == 442 )
			continue;
		if(svtClass != -1)
		{
